...
$i_message['install_lock'] = '您已安装过tweibo ' . $_TSVERSION . '，如果需要重新安装，请先删除install目录下的install.lock文件';
$i_message['install_title'] = 'tweibo ' . $_TSVERSION . ' 安装向导';
$i_message['install_wizard'] = '安装向导';
$i_message['install_warning'] = '<strong>注意 </strong>这个安装程序仅仅用在你首次安装ThinkSNS。如果你已经在使用 tweibo 或者要更新到一个新版本，请不要运行这个安装程序。';
...
$i_message['mysql_unsupport'] = '您的服务器不支持MYSQL数据库，无法安装tweibo。';
...
$i_message['thinksns_rebuild'] = '数据库中已经安装过 tweibo，继续安装会清空原有数据！';
...
$i_message['install_success_intro'] = '<p>安装程序执行完毕，请尽快删除整个 install 目录，以免被他人恶意利用。如要重新安装，请删除本目录的 install.lock 文件！</p><p><a href="../index.php">请点击这里开始体验tweibo吧！</a></p>';
