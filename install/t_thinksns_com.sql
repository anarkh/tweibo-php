...
-- ----------------------------
-- Table structure for `t_user_member`
-- ----------------------------
...
CREATE TABLE `t_user_member` (
  ...
  `open_key` varchar(45) NOT NULL,
  `access_token` varchar(45) NOT NULL,
  `expires_in` varchar(25) NOT NULL,
  `refresh_token` varchar(45) NOT NULL,
  `access_time` varchar(25) DEFAULT '0',
  `member_type` varchar(10) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `id_idx` (`uid`),
  CONSTRAINT `id` FOREIGN KEY (`uid`) REFERENCES `t_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `t_blog` (
  ...
  `blog_type` varchar(45) DEFAULT NULL,
  `image_head` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
